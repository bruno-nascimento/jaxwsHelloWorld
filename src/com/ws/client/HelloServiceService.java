 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://ws.com/", wsdlLocation = "http://localhost:8080/ws/hello?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://ws.com/", "HelloServiceService");
    ...
    public ClientService getHelloServicePort() {
        return super.getPort(new QName("http://ws.com/", "HelloServicePort"), ClientService.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloServicePort")
    public ClientService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.com/", "HelloServicePort"), ClientService.class, features);
    }
